...
<h4>Register Here <span class="glyphicon glyphicon-hand-right"> <a href="${pageContext.servletContext.contextPath}/Register?id={{x.Id}}" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-user">SignUp</span></a>
