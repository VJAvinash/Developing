...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="${pageContext.request.contextPath}/Register"><span class="glyphicon glyphicon-user"></span> Signup</a></li>
...
<table class="table table-striped table-hover">
  ...
  <tr ng-repeat="x in names | filter:searchBy">
    ...
    <td>{{x.Description}}</td>
    <td>
    <a href="${pageContext.servletContext.contextPath}/ShowProducts?id={{x.id}}" class="btn btn-info active"><span class="glyphicon glyphicon-search"> View</span></a>
