...
<table class="table table-striped table-hover">
  ...
  <tr ng-repeat="x in names | filter:searchBy">
    ...
    <td>{{x.Description}}</td>
    <td>
    <a href="${pageContext.servletContext.contextPath}/viewproduct?id={{x.Id}}" class="btn btn-info"class="btn btn-info"><span class="glyphicon glyphicon-search"> View</span></a>
    <sec:authorize access="hasRole('ROLE_ADMIN')">
