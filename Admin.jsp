...
<nav class="navbar navbar-default"role="navigation">
  ...
  <a href="${pageContext.servletContext.contextPath}/ManageProducts?id={{x.Id}}" class="btn btn-info"class="btn btn-info"><span>Products</span></a>
    <a href="${pageContext.servletContext.contextPath}/ManageSuppliers?id={{x.Id}}" class="btn btn-primary"><span>Suppliers</span></a>
    <a href="${pageContext.servletContext.contextPath}/Admin?id={{x.Id}}" class="btn btn-danger"><span>Users</span></a>
  </div>
  </div>
  <br>
  <div class="container">
