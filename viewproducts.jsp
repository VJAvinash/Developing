...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <sec:authorize access="hasRole('ROLE_USER')">
      <a class="navbar-brand" href="#">Headphones.com</a>
      </sec:authorize>
    ...
    <ul class="nav navbar-nav navbar-right">
     <sec:authorize access="hasRole('ROLE_USER')"> 
      ...
      <div class="container">
            ...
            <sec:authorize access="hasRole('ROLE_USER')">
            <tr><td></td><td><a href="viewcart?id=${product.id}" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-shopping-cart"> ADD TO CART</a>
              </td></tr></sec:authorize>               
            </table>
      </div>
